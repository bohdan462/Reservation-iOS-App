...
20. **Regulars / Guest Memory** — `RegularGuestsView` still network-page-first (25 per page); **not** disk-first; does not open `GuestProfileDetailView` — Slice 3R open.
