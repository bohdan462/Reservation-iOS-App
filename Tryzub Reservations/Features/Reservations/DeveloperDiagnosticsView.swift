...
struct DeveloperDiagnosticsView: View {
    ...
    private var endpointChecklistSection: some View {
        Section("Endpoint Contract Checklist") {
            ...
            endpointRow("GET /managed-reservations/{id}/activity", pathFragment: "/activity")
            endpointRow("GET /activity", pathFragment: "/activity")
            endpointRow("GET /guest-intelligence", pathFragment: "/guest-intelligence")
            endpointRow("GET /restaurant-tables", pathFragment: "/restaurant-tables")
            endpointRow("GET /floor-plan", pathFragment: "/floor-plan")
            endpointRow("PATCH /managed-reservations/{id}/tables", pathFragment: "/tables")
